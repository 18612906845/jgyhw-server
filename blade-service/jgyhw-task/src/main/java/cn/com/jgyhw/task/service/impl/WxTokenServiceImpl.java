...
public class WxTokenServiceImpl implements IWxTokenService {
	...
	@Value("${jgyhw.wxGzh.wxUpdateServiceApiTokenReqUrl:}")
	private String wxUpdateServiceApiTokenReqUrl;
	...
	@Value("${jgyhw.wxXcx.appId:}")
	private String wxXcxAppId;

	@Value("${jgyhw.wxXcx.appSecret:}")
	...
	public void timingUpdateWxGzhServiceApiToken() {
		String url = wxUpdateServiceApiTokenReqUrl;
	...
	public void timingUpdateWxXcxServiceApiToken() {
		String url = wxUpdateServiceApiTokenReqUrl;
		if(!StringUtils.isBlank(url)){
			url = url.replaceAll("APPID", wxXcxAppId);
			url = url.replaceAll("APPSECRET", wxXcxAppSecret);
		}else{
